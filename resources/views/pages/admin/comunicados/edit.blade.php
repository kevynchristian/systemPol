...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-white glitch" data-text="EDITAR COMUNICADO">EDITAR COMUNICADO</h1>
    ...
    <div class="card-tactical shadow mb-4">
        <div class="card-header-tactical py-3">
            <h6 class="m-0 font-weight-bold"><i class="fas fa-pen"></i> DADOS DO COMUNICADO</h6>
        </div>
        <div class="card-body-tactical">
            <form action="{{ route('admin.comunicados.update', $comunicado->id) }}" method="POST">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control input-tactical" id="title" name="title" value="{{ old('title', $comunicado->title) }}" required maxlength="255">
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-4">
                        <select name="type" id="type" class="form-control input-tactical" required>
                            <option value="info" {{ old('type', $comunicado->type) == 'info' ? 'selected' : '' }}>Informação Geral</option>
                            <option value="alerta" {{ old('type', $comunicado->type) == 'alerta' ? 'selected' : '' }}>Alerta / Prioridade</option>
                            <option value="aula" {{ old('type', $comunicado->type) == 'aula' ? 'selected' : '' }}>Aviso de Treinamento</option>
                        </select>
                    </div>

                    <label for="image_url" class="col-sm-2 col-form-label text-right">URL DA IMAGEM:</label>
                    <div class="col-sm-4">
                        <input type="url" class="form-control input-tactical" id="image_url" name="image_url" value="{{ old('image_url', $comunicado->image_url) }}" placeholder="https://imgur.com/... (Opcional)">
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control input-tactical" id="content" name="content" rows="6" required placeholder="Escreva a mensagem aqui...">{{ old('content', $comunicado->content) }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10 text-left">
                        <div class="custom-control custom-checkbox custom-checkbox-tactical">
                            <input type="checkbox" class="custom-control-input" id="active" name="active" value="1" {{ old('active', $comunicado->active) ? 'checked' : '' }}>
